...
class TwoSectionModule extends Component {
  ...
  render() {
    return (
      <div style={{width:"calc(25vw - 20px)",height:"calc(50vw - 40px)",verticalAlign: "super"}} onClick={(e) => {
        this.setState({openModal: true})}}>
        <div style={{width:"calc(25vw - 20px)",height:"calc(25vw - 20px)",borderBottom:"1px solid " + yellow[400]}}/>
